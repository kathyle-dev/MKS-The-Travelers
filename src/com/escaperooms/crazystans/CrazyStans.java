...
//
//public class CrazyStans extends EscapeRoomGame {
...
//
//    @Override
//    public void run(Traveler traveler, EscapeRoomGame escapeRoomGame) {
...
//        EscapeRoomGame.prompt("Type 'start' to begin the challenges ", "start", "Invalid command");
